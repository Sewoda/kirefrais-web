...
<template>
  <div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center gap-4">
      ...
      <h2 class="font-display font-semibold text-xl text-gray-900">Nouveau kit repas</h2>
    </div>

    <form @submit.prevent="save" class="grid grid-cols-1 md:grid-cols-3 gap-6 pb-20">
